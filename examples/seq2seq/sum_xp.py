...
@dataclass
class SumDataTrainingArguments(DataTrainingArguments):
    """
...
class SumXP(XP):
    ...
    def create_trainer(self):
        ...
        self.trainer = self.SUM_TRAINER_CLASS(
            model=None,
            args=training_args,
        ...
        self.trainer._max_length = data_args.val_max_target_length
